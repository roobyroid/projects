...
(function (cjs, an) {
  ...
  var ss = {};
  var img = {};
  lib.ssMetadata = [{ name: 'star_atlas_1', frames: [[0, 0, 728, 741]] }];
  ...
  (lib.Symbol1 = function (mode, startPosition, loop, reversed) {
    ...
    this.shape.graphics
      .rf(['#FFFFFF', 'rgba(255,255,255,0)'], [0, 1], 0.1, 0, 0, 0.1, 0, 92.7)
      .s()
      .p('AGmHyQjOivkNkNQkNkNivjOQivjOAWgWQAXgXDOCvQDPCvELENQEPEMCuDPQCuDOgVAXQgDACgFAAQgmAAi3ibg');
  ...
  (lib.LIGHT = function (mode, startPosition, loop, reversed) {
    ...
    this.shape = new cjs.Shape();
    this.shape.graphics
      .rf(['#FFFFFF', 'rgba(255,255,255,0)'], [0, 1], 0, 0, 0, 0, 0, 88.9)
      .s()
      .p('ApuJwQkCkCAAluQAAlsECkDQEBkBFtAAQFtAAECEBQECEDAAFsQAAFukCECQkCEBltAAQltAAkBkBg');
  ...
  (lib.G11 = function (mode, startPosition, loop, reversed) {
    ...
    this.shape = new cjs.Shape();
    this.shape.graphics
      .rf(['#FFFFFF', 'rgba(255,255,255,0)'], [0, 1], 0, 0, 0, 0, 0, 70.2)
      .s()
      .p('AnrHsQjMjLAAkhQAAkfDMjMQDLjMEgAAQEgAADMDMQDMDMAAEfQAAEhjMDLQjMDMkgAAQkgAAjLjMg');
    ...
    this.shape_1.graphics
      .rf(['#FFFFFF', 'rgba(255,255,255,0)'], [0, 1], 0, 0, 0, 0, 0, 139)
      .s()
      .p('AvNPPQmUmTAAo8QAAo6GUmUQGTmTI6AAQI7AAGTGTQGUGUAAI6QAAI8mUGTQmTGTo7AAQo6AAmTmTg');
  ...
  (lib.STAAR = function (mode, startPosition, loop, reversed) {
    ...
    this.timeline.addTween(
      cjs.Tween.get(this.instance_4)
        .wait(21)
        .to({ _off: false }, 0)
        .to({ regY: 191.2, scaleX: 0.1525, scaleY: 0.1525, x: 174.75, alpha: 1 }, 14)
        .to({ scaleX: 0.0795, scaleY: 0.0795, alpha: 0 }, 15)
        .wait(1),
    );
    ...
    this.timeline.addTween(
      cjs.Tween.get(this.instance_5)
        .to({ regY: 191.2, scaleX: 0.1525, scaleY: 0.1525, x: 17.3, alpha: 1 }, 14)
        .to({ scaleX: 0.0795, scaleY: 0.0795, alpha: 0 }, 15)
        .wait(22),
    );
  ...
  (lib.star = function (mode, startPosition, loop, reversed) {
    ...
    this.shape.graphics
      ...
      .s('rgba(0,0,0,0)')
      .ss(1, 1, 1, 3, true)
      .p('EgpFgpFMBSLAAAMAAABSLMhSLAAAg');
  ...
  // library properties:
  lib.properties = {
    id: '9CF9F763DF48B74799E8DB9793799DA6',
    width: 506,
    height: 506,
    fps: 30,
    color: '#000000',
    opacity: 0.0,
    manifest: [{ src: 'img/page/star_atlas_1.png', id: 'star_atlas_1' }],
    preloads: [],
  };
  ...
  an.compositions['9CF9F763DF48B74799E8DB9793799DA6'] = {
    getStage() {

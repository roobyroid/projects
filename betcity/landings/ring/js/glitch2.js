class BackgroundImage {
    constructor() {
        this.uniforms = {
            ...
            imageResolution: {
                ...
                value: new THREE.Vector2(3840, 2160),
            },
            texture: {
                type: 't',
                value: null,
    ...
    resize() {
        // console.log('bgImg.resize =>', window.innerWidth, window.innerHeight);
        this.uniforms.resolution.value.set(window.innerWidth, window.innerHeight);
    }

    resizeResolution() {
        // console.log('bgImg.resizeResolution..');
        this.uniforms.imageResolution.value.set(window.innerWidth, window.innerHeight);
    }
}
...
const resizeWindow = () => {
    ...
    bgImg.resize();
    if (isMobile.any()) bgImg.resizeResolution();
    postEffect.resize();
...
const init = () => {
    ...
    var bg,bg2;
    if (isMobile.any()){
        bg = './img/bg/bg_mob.jpg';
        bg2 = './img/bg/bg2_mob.jpg';
    } else {
        bg = './img/bg/bg.jpg';
        bg2 = './img/bg/bg2.jpg';
    }

    var bgDesktop = document.querySelector('.s-hero__bg-main._desktop');
    var bgMob = document.querySelector('.s-hero__bg-main._mob');
    var content = document.querySelector('.s-hero__content');
    ...
    bgImg.init(bg, () => {
        ...
        if (isMobile.any()) bgMob.classList.remove('hide');
        else bgDesktop.classList.remove('hide');
        content.classList.remove('hidden');
        // document.querySelector('.bg-ringe').classList.remove('hide');

        setTimeout(function(){
            bgImg.init(bg2, () => {
                sceneBack.add(bgImg.obj);
                btnReg.classList.add('animated')
            });
        }, 3000);

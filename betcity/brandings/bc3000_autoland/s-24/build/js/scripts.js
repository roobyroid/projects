    ...
    function animate(elements) {
      ...
      tl.to(
        elements[1],
        {
          ...
          onStart: function () {
            ...
            // document.body.classList.add('js-animation-second-frame')
            // document.body.classList.remove('js-animation-first-frame')
          },
          onComplete: function () {},
        },
        '>'
      ...
      tl.to(
        elements[1],
        {
          ...
          duration: 0.3,
          onStart: function () {
            // document.body.classList.add('js-animation-first-frame')
            // document.body.classList.remove('js-animation-second-frame')
            changeAsideHeight('.aside__content-first');
          },
        },
        '>'

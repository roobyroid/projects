...
(function (cjs, an) {
  ...
  (lib.o = function (mode, startPosition, loop, reversed) {
    ...
    // Layer_1
    this.shape = new cjs.Shape();
    this.shape.graphics.f('#2EF3D0').s().p('AAAA0QgNgBgNgIQgNgJgHgLQgGgMAAgMQAAgNAIgNQAIgNAMgGQAMgGAMABQANACAOAIQANAIAHAMQAGALAAANQAAANgIAMQgIANgMAGQgLAFgMAAIgCAAgAgDgRQgHABgEAHQgFAIABAGQACAIAHAEQAHAEAGgCQAHgCAEgHQAFgIgBgGQgBgHgHgEQgFgDgEAAIgFABg');
    this.shape.setTransform(13.375, 20.4949);
  ...
  (lib.h = function (mode, startPosition, loop, reversed) {
    ...
    // Layer_1
    this.shape = new cjs.Shape();
    this.shape.graphics.f('#2EF3D0').s().p('AACBEIATguQADgHgCgGQgCgFgHgEQgHgBgGABQgFACgDAIIgTAtIghgNIAzh6IAgAOIgTAvIAHgEQAFgCAHAAQAGgBAIAEQALAFAGAHQAGAIABAJQAAALgFAKIgVA1g');
    this.shape.setTransform(11.8273, 19.15);
  ...
  (lib._P = function (mode, startPosition, loop, reversed) {
    ...
    // Layer_1
    this.shape = new cjs.Shape();
    this.shape.graphics.f('#2EF3D0').s().p('AhBA+IAKh+IBNAGQAXACALAMQAMAMgCAWQgCAUgNAKQgNAKgXgCIgogEIgEApgAgXgGIAkADQAIABADgDQAEgDABgFQAAgGgDgEQgDgDgIgBIgkgDg');
  ...
  (lib._n = function (mode, startPosition, loop, reversed) {
    ...
    // Layer_1
    this.shape = new cjs.Shape();
    this.shape.graphics.f('#2EF3D0').s().p('AgTAqIAlgeQAGgGABgFQABgGgFgGQgFgFgGgBQgGgBgFAFIgnAeIgWgbIBJg7IAWAcIgKAIIAJAAQAFABAGADQAGADAFAGQAIAKABAJQABAKgEAIQgFAKgJAHIgsAkg');
    this.shape.setTransform(14.2438, 18.45);
  ...
  (lib._e = function (mode, startPosition, loop, reversed) {
    ...
    // Layer_1
    this.shape = new cjs.Shape();
    this.shape.graphics.f('#2EF3D0').s().p('AgFA2QgHAAgHgEQgGgDgHgHQgGgHgGgLQgGgQAAgMQABgOAHgLQAIgLANgGQAOgGAMABQANABAKAIQALAJAGAOQAHAOgBAMQAAANgIALQgHALgOAGIgHADIgcg+QgGAEgCAHQgCAFAEAIQACAFADACQADADACAAIAOAgIgFABIgFAAgAAEgVIAOAeQAFgEACgFQABgFgDgGQgDgGgEgCQgEgDgFAAIgDABg');
    this.shape.setTransform(14.5768, 15.2809);
  ...
  (lib._5 = function (mode, startPosition, loop, reversed) {
    ...
    // Layer_1
    this.shape = new cjs.Shape();
    this.shape.graphics.f('#2EF3D0').s().p('AgnAwQgLgGgHgLQgHgLgBgRQgBgNAEgLQADgKAGgHQAGgGAIgEQAHgDAIAAIACAkIgFADQgDACgCADQgCAEABAEQAAAHAFAEQAFAFAHgBQAHAAAEgFQAEgFAAgGIgCgHQgCgEgCgBIgEgBIgCghIBKgEIAFBcIgcACIgEg7IgSABQAEADADAGQADAFABAIQAAAMgEAKQgFAKgKAFQgIAGgOABQgOAAgLgEg');
    this.shape.setTransform(14.4889, 9);
  ...
  (lib.Phone = function (mode, startPosition, loop, reversed) {
    ...
    this.instance.setTransform(116.3, 121.45, 2.5184, 2.5184, 0, 0, 0, 30.5, 30.6);
  ...
  p.nominalBounds = new cjs.Rectangle(128.8, 98, 85.29999999999998, 232.3);
  // library properties:
  lib.properties = {
    id: 'E5142963BBF42642861D7CA09E5FDC97',
    width: 230,
    height: 230,
    fps: 30,
    color: '#000000',
  ...
  an.compositions['E5142963BBF42642861D7CA09E5FDC97'] = {
    getStage() {

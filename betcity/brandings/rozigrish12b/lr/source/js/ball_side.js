...
(function (cjs, an) {
  ...
  // stage content:
  (lib.ball_side = function (mode, startPosition, loop, reversed) {
    if (loop == null) {
      loop = true;
    }
    if (reversed == null) {
    ...
    this.shape.setTransform(174.9799, 40.4805, 0.8802, 0.3802);

    this.timeline.addTween(cjs.Tween.get(this.shape).wait(96));

    // small
    this.instance = new lib.small();
    this.instance.setTransform(115.55, -311.2, 0.5013, 0.5013, 0, 0, 0, 53.6, 55.5);
    this.instance._off = true;

    this.timeline.addTween(cjs.Tween.get(this.instance).wait(2).to({_off: false}, 0).to({y: -75.5}, 25, cjs.Ease.backOut).wait(42).to({y: -311.2}, 25, cjs.Ease.backIn).wait(2));

    // bac
    this.instance_1 = new lib.bac();
    this.instance_1.setTransform(294.75, -290.7, 0.5013, 0.5013, 0, 0, 0, 107, 97.5);
    this.instance_1._off = true;

    this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(6).to({_off: false}, 0).to({y: -55}, 25, cjs.Ease.backOut).wait(34).to({y: -290.7}, 25, cjs.Ease.backIn).wait(6));

    // foot
    this.instance_2 = new lib.foot();
    this.instance_2.setTransform(1.25, -342.6, 0.5013, 0.5013, 0, 0, 0, 165.5, 166);
    this.instance_2._off = true;

    this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(4).to({_off: false}, 0).to({regY: 165.8, y: -107}, 25, cjs.Ease.backOut).wait(38).to({regY: 166, y: -342.6}, 25, cjs.Ease.backIn).wait(4));

    // BG2
    this.instance_3 = new lib.BGBG2();
    this.instance_3.setTransform(83, 140.55, 0.5013, 0.5013, 0, 0, 0, 247.1, 369.9);

    this.timeline.addTween(cjs.Tween.get(this.instance_3).to({alpha: 0}, 6).wait(83).to({alpha: 1}, 6).wait(1));

    // BG_img
    this.instance_4 = new lib.IMG_BG();
    this.instance_4.setTransform(189.65, 113.6, 0.2135, 0.2135, 0, 0, 0, 550.5, 275.9);
    this.instance_4.compositeOperation = 'lighten';

    this.timeline.addTween(cjs.Tween.get(this.instance_4).to({regY: 275.7, scaleX: 0.3328, scaleY: 0.3328, y: 99.2}, 18, cjs.Ease.cubicInOut).wait(59).to({regY: 275.9, scaleX: 0.2135, scaleY: 0.2135, y: 113.6}, 18, cjs.Ease.cubicIn).wait(1));

    // stageBackground
    this.shape_1 = new cjs.Shape();
    this.shape_1.graphics.f().s('rgba(0,0,0,0)').ss(1, 1, 1, 3, true).p('A/UweMA+pAAAMAAAAg9Mg+pAAAg');
    this.shape_1.setTransform(190.5, 95.5);

    this.shape_2 = new cjs.Shape();
    this.shape_2.graphics.f('#081051').s().p('A/UQfMAAAgg9MA+pAAAMAAAAg9g');
    this.shape_2.setTransform(190.5, 95.5);

    this.timeline.addTween(cjs.Tween.get({}).to({state: [{t: this.shape_2}, {t: this.shape_1}]}).wait(96));

    this._renderFirstFrame();

  }).prototype = p = new lib.AnMovieClip();
  p.nominalBounds = new cjs.Rectangle(136.2, -193.4, 290.3, 439.1);
  // library properties:
  lib.properties = {
    id: 'D4379D299E48794E8C2650E82FD8DF21',
    width: 381,
    height: 191,
    fps: 30,
    color: '#081051',
    opacity: 1.00,
    manifest: [
      {src: 'img/sideBall/ball1.png', id: 'ball1'},
      {src: 'img/sideBall/ball2.png', id: 'ball2'},
      {src: 'img/sideBall/BALL3.png', id: 'BALL3'},
      {src: 'img/sideBall/IMGBG.png', id: 'IMGBG'},
      {src: 'img/sideBall/Mob.png', id: 'Mob'},
      {src: 'img/sideBall/Snow.png', id: 'Snow'},
      {src: 'img/sideBall/Snow1.png', id: 'Snow1'},
      {src: 'img/sideBall/Snow3.png', id: 'Snow3'}
    ],
    preloads: [],
  };
  ...
  an.compositions['D4379D299E48794E8C2650E82FD8DF21'] = {
    getStage() {
